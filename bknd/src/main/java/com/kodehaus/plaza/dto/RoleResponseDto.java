...
public class RoleResponseDto {
    ...
    public RoleResponseDto(Long id, String name, String description, Boolean isActive, LocalDateTime createdAt,
                          LocalDateTime updatedAt, Set<PermissionResponseDto> permissions) {
        this.id = id;
        this.name = name;
